...
## 📂 Project Structure
        ├── config/                  # Configuration settings (paths, params)
        ├── data_collection/         # Scripts for downloading Yahoo Finance data
        ├── preprocessing/           # PySpark feature engineering scripts
        ├── sql_interface/           # Database manager for SQLite
        ├── ml_models/               # Spark GBT and Random Forest models
        ├── chatbot/                 # AI Chatbot logic
        ├── dashboard/               # Power Bi dashboard
        ├── data/                    # Storage for CSVs, Parquet, and DB (Git ignored)
...
## 📜 Disclaimer
This project is for educational purposes only. The financial predictions generated by the AI models should not be used as financial advice. Always do your own research.
